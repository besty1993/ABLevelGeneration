...
public class ABConstants {
	...
	//ABLG!!
	public static readonly string SUBSETS_FOLDER = "/StreamingAssets/Subsets";
	public static readonly string EVALUATED_SUBSETS_FOLDER = "/StreamingAssets/EvaluatedSubsets";
